...
contract DeployFoodSafetyGovernance is Script {
    ...
    function _verifyDeployment() internal view {
        ...
        require(governance.admin() == deployer, "Governance admin not set correctly");
        ...
        require(votingManager.admin() == deployer, "VotingManager admin not set");
        ...
        require(disputeManager.admin() == deployer, "DisputeManager admin not set");
        ...
        require(rewardManager.admin() == deployer, "RewardManager admin not set");
