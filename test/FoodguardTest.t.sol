...
contract FoodguardTest is Test, CodeConstants {
    ...
    function testDeploymentInitializesCorrectly() public view {
        ...
        assert(address(governance.votingDisputeManager()) == address(votingManager));
    }
    ...
    function testUserRegistrationWorks() public {
        ...
        governance.registerUser(newUser, uint8(DataStructures.UserRole.COMPLAINANT));
        
        (bool registered, DataStructures.UserRole role, bool active, uint256 reputation) = 
    ...
    function testCreateComplaintWorks() public usersRegisteredAndFunded {
        ...
        (uint256 storedCaseId,
         ...
         uint256 enterpriseDeposit,,,) = governance.cases(caseId);
    ...
    function testCreateComplaintRevertsWithInvalidEnterprise() public usersRegisteredAndFunded {
        vm.prank(COMPLAINANT);
        vm.expectRevert();
    ...
    /*//////////////////////////////////////////////////////////////
                        INTEGRATION TESTS
    //////////////////////////////////////////////////////////////*/
    function testCompleteWorkflowBasic() public usersRegisteredAndFunded skipFork {
        // 1. Create complaint
        vm.prank(COMPLAINANT);
        uint256 caseId = governance.createComplaint(
            ENTERPRISE,
    ...
    function testSystemHandlesMultipleCases() public usersRegisteredAndFunded skipFork {
